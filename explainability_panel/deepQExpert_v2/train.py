# python train.py --save_path="ai4realnet_small" --num_train_steps=10000 --name="DeepQExpert" --logs_dir="ai4realnet_small/logs"
#!/usr/bin/env python3
# python train.py --save_path=./deepqsimple_saved --num_train_steps=1024
...
if __name__ == "__main__":
    ...
    #                      "set_topo_vect": False
    #                      }
    with open("../ressources/action_list.pkl", "rb") as file:
        expert_actions = pickle.load(file)
    # add the DoNothing Action to the list of expert actions
    # expert_actions.insert(0, env.action_space({}))
    kwargs_converters = {"all_actions": expert_actions}
    
    nm_ = args.name if args.name is not None else DEFAULT_NAME
    # try:
    agent = baseline = train(env,
                     name=nm_,
