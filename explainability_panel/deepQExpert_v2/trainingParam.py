...
class TrainingParam(object):
    ...
    def final_epsilon2(self, final_epsilon):
        self._final_epsilon2 = final_epsilon
        self._compute_exp_facto()
    ...
    def initial_epsilon2(self, initial_epsilon):
        self._initial_epsilon2 = initial_epsilon
        self._compute_exp_facto()
